const options = {
  ...
  centerToEdgeAlignment: true, // Center to edge alignment
  ...
  gridColor: "#bfbfbf", // Color of grid lines
  ...
  guidelinesStyle: {
    ...
    horizontalDistColor: "#8b7d6b", // color of horizontal distribution alignment
    verticalDistColor: "#8b7d6b", // color of vertical distribution alignment
...
const getSnapToGridOptions = () => {
  return options;
};

module.exports = getSnapToGridOptions;
